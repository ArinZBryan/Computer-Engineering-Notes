...
> For instance, a school might have a computer room with up to 28 computers, a router and a switch in it that all need an IP address. To facilitate this, the school might rent a block of 32 addresses (a `/5`) and allocate them as follows:
> - `134.237.12.0` ([reserved](#IPv4%20Per-Subnet%20Reserved%20Addresses))
> - `134.237.12.1` (the router)
...
> - `134.237.12.31` ([reserved](#IPv4%20Per-Subnet%20Reserved%20Addresses))
