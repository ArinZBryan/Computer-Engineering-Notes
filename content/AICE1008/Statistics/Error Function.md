...
$$
As it turns out, this integral has no closed form using the elementary functions. The best effort of representing it is to use its [Maclaurin Series](../../AICE1004/Calculus/Differential%20Calculus.md#Taylor%20Series). This also is not a nice, tidy formula:
$$
