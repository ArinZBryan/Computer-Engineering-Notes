...
The most basic of the one-dimensional integrals is the [Riemann Integral](../../AICE1004/Calculus/Integral%20Calculus.md#Definite%20Integration). Here, we sum the areas of increasingly smaller slices of the area between the curve and the $x$-axis. This is defined more formally as:
$$
