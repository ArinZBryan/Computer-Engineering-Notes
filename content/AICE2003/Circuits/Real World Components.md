...
### I/V Graphs
![I/V Graph of a resistor|float-right|225](images/Resistor%20IV%20Graph.png)An I/V (current/voltage) graph is a common tool used to analyse the specific characteristics of any given circuit component.
