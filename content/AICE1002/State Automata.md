...
###### Maps
![Excitation Map to Transition Map|float-right](images/State_Automata/Excitation%20To%20Transition%20Maps.png)The next step is to derive the correct combinational logic to produce the next state, given the current one. To do this, we use a [Karnaugh Map](Combinatorial%20Logic.md) per bit of state stored. In this case, this K-Map is called the *Excitation Map*. 
...
![Optimisation for a JK Bistable|centre](images/State_Automata/Optimisation%20for%20JK%20Bistable.png)
...
![Storage Type Optimisation for an SR Bistable|centre](images/State_Automata/Optimisation%20for%20SR%20Bistable.png)
### Up / Down Counter
